...
When the year is done, the books are expected to be returned. They will arrive at the shipping and receiving office where each book bar code is scanned.  The student that the books are assigned to will come up on the screen. Each book is evaluated as "returned" or “written off” if not in good condition, and the inventory file is updated to reflect this.  The students registration info is updated as having returned all books and the student is sent an email confirming receipt of the books.
