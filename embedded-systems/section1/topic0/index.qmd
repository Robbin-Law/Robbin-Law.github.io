...
- From the submodule copy the demo that you are interested in to another part of your workbook repo, then you can make changes to the demo and experiment, and save your work in the workbook repo. You cannot save work to the submodule as it is read only.
